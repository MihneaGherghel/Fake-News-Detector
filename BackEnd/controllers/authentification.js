...
const {validationSignUp, hashPassword}=require('../utils/authentification/utilSignup')
const {createJSONToken, isValidPassword}=require("../utils/authentification/utilLogin")
...
module.exports.signup=async (req,res)=>{
    ...
    const validationErrors=validationSignUp(name,email,password,confirmPassword)
    ...
    try{
        ...
        data=[name,email,hashPass]
        await db.query('INSERT INTO fake_news.users (name,email,password) VALUES (?)',[data]);
