...
export default function Footer(){
    return (
        <footer class='pt-14 pb-10 max-sm:pt-10 max-sm:pb-5 bg-myRed flex justify-around'>
            <section>
                <h2 class='text-3xl mb-5 max-sm:text-2xl max-sm:mb-3 font-bold'>Contact</h2>
            ...
            <section>
                ...
                <Information>Email: mihnea.gherghel@gmail.com</Information>
