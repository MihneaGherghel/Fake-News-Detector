export function SubscriptionProfile({name,email,date}){
    return (
        <div class="sticky top-0 w-1/2 max-sm:static max-sm:w-screen max-sm:text-center h-full max-w-md pl-10 flex flex-col justify-center">
            ...
            <p class="mt-10">
                ...
                of <span class="text-myRed font-bold">100,000</span> news articles until <span class="text-myRed font-bold">{date}</span>.
