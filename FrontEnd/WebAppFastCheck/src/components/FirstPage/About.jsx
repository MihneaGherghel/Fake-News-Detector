export default function About(){
    return (
        <div class=" h-screen max-sm:h-[51rem] relative ${styleSection} mb-10">
            <div class="py-32 pl-12 pr-64 w-7/12 left-20 h-5/6 max-sm:p-8 max-sm:text-center max-sm:w-5/6 max-sm:left-8 absolute top-24 bg-myRed rounded-sm">
                <h2 class="text-4xl max-sm:text-xl  font-bold mb-3">About us</h2>
            ...
            {window.innerWidth>640 &&<div class="absolute bg-[url('./aboutImage.jpg')] bg-cover w-5/12 h-2/3 right-[120px] top-40 rounde-sm"></div>}
        </div>
    )
}